...
public class qdAction {
	...
	@RequestMapping("/findcheckcompany")
	@ResponseBody
	public String findcheckcompany(HttpServletRequest request,@RequestParam("channel_id") String channel_id) {
		String msg = qdServer.findcheckcompany(channel_id);
	    return msg;
	}
